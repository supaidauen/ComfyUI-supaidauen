  ...
  def INPUT_TYPES(cls):
    return {
      "required": {
        ...
        "value09": ("FLOAT", {"default": 2.5, "min": -10000.0, "max": 10000.0, "step": 0.05 }),
        "value10": ("FLOAT", {"default": 5.0, "min": -10000.0, "max": 10000.0, "step": 0.05 }),
        "value11": ("FLOAT", {"default": 1.1, "min": -10000.0, "max": 10000.0, "step": 0.05 }),
        "value12": ("FLOAT", {"default": 4.0, "min": -10000.0, "max": 10000.0, "step": 0.05 }),
